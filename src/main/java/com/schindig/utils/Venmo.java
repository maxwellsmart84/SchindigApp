...
public class Venmo {
    ...
    private static final String frontEnd = "https://api.venmo.com/v1/oauth/authorize?client_id=3361&scope=make_payments%20access_profile&response_type=code&redirect_uri=http://104.236.244.159:8100/venmo/";
